<img align="right" src="./images/safety_london.png" width="30%" height="30%">
...
3. Analysing the correlation of crime with population density and with a number of tourist attractions in each Borough.
